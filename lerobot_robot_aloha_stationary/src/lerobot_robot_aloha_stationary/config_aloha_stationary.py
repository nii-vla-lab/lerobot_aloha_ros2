...
@RobotConfig.register_subclass("aloha_stationary")
@dataclass
class AlohaStationaryConfig(RobotConfig):
    """
    Configuration for the Stationary ALOHA Follower robot (dual-arm).

    Attributes:
        name (str): Robot instance name (default: "follower").
